...
public class CartProductStaysAfterLoginTest {
	...
	private static int deleteButtons;
	...
	public CartProductStaysAfterLoginTest(String browser){
	...
	@Test
	public void testProductStaysAfterLogin() throws Exception {
