...
public class CartMoreProductsAddingTest {
	...
	public CartMoreProductsAddingTest(String browser){
	...
	@Test
	public void testProductsAdding() throws Exception {
		...
		Thread.sleep(2000);
		driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
		//checks if there are two products in the cart
		assertEquals("Quantity of products in the cart was incorrect", "2 produkty", driver.findElement(By.xpath("//span[@id='header-cart-item-count-text']")).getText());
	}
