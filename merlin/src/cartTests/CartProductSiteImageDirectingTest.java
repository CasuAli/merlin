...
public class CartProductSiteImageDirectingTest {
	...
	public CartProductSiteImageDirectingTest(String browser){
	...
	@Test
	public void testImageDirecting() throws Exception {
		
		//checks if there clicking on the product's image directs user to its site
		driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//a[@class='img cart-item__image']")).click();
